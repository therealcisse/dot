...
|---------|-------|------------|-------------------|
| `ux-expert` | UX Expert | User research, information architecture, user journey | 4 |
| `ui-designer` | UI Designer | Visual design, high-fidelity mockups, design systems | 4 |
| `system-architect` | System Architect | Technical architecture, scalability, integration patterns | 5 |
| `product-manager` | Product Manager | Product strategy, roadmap, prioritization | 4 |
| `product-owner` | Product Owner | Backlog management, user stories, acceptance criteria | 4 |
| `scrum-master` | Scrum Master | Process facilitation, impediment removal, team dynamics | 3 |
| `subject-matter-expert` | Subject Matter Expert | Domain knowledge, business rules, compliance | 4 |
| `data-architect` | Data Architect | Data models, storage strategies, data flow | 5 |
| `api-designer` | API Designer | API contracts, versioning, integration patterns | 4 |
...
const roleConfig = {
  'ux-expert': {
    ...
    question_count: 4,
    template: 'templates/role-templates/ux-expert-template.md'
  },
  'ui-designer': {
    title: 'UI Designer',
    ...
    question_count: 4,
    template: 'templates/role-templates/ui-designer-template.md'
  },
  'system-architect': {
    ...
    question_count: 5,
    template: 'templates/role-templates/system-architect-template.md'
  },
  'product-manager': {
    ...
    question_count: 4,
    template: 'templates/role-templates/product-manager-template.md'
  },
  'product-owner': {
    title: 'Product Owner',
    ...
    question_count: 4,
    template: 'templates/role-templates/product-owner-template.md'
  },
  'scrum-master': {
    title: 'Scrum Master',
    ...
    question_count: 3,
    template: 'templates/role-templates/scrum-master-template.md'
  },
  'subject-matter-expert': {
    ...
    question_count: 4,
    template: 'templates/role-templates/subject-matter-expert-template.md'
  },
  'data-architect': {
    ...
    question_count: 5,
    template: 'templates/role-templates/data-architect-template.md'
  },
  'api-designer': {
    title: 'API Designer',
...
|----------|-------|--------------------------|
| User Intent | User Goals | "What is the core objective of this analysis?" |
| Requirements | Requirements Refinement | "How should requirements be prioritized?" |
| Architecture | Architecture Decisions | "Technology stack selection considerations?" |
| UX | User Experience | "Interaction complexity trade-offs?" |
| Feasibility | Feasibility | "Implementation scope under resource constraints?" |
| Risk | Risk Management | "What is the risk tolerance level?" |
| Process | Process Standards | "Development iteration cadence?" |
| Decisions | Decision Confirmation | "Conflict resolution approach?" |
| Terminology | Terminology Alignment | "Which terminology to standardize on?" |
| Scale & Performance | Scale & Performance | "Expected load and performance requirements?" |
| Technical Constraints | Technical Constraints | "Existing technology stack limitations?" |
| Architecture Complexity | Architecture Complexity | "Architecture complexity trade-offs?" |
| Non-Functional Requirements | Non-Functional Requirements | "Availability and maintainability requirements?" |
...
for (let i = 0; i < questions.length; i += BATCH_SIZE) {
  ...
  console.log(`\n[Round ${currentRound}/${totalRounds}] ${config.title} Context Inquiry\n`);
...
- ❌ Overly abstract generic questions
- ❌ Repetitive questions disconnected from the framework
...
**Context Quality**:
- [ ] Questions in English with business context
